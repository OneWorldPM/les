...
var Main = function () {
    ...
    var settingsHandler = function () {
        ...
        $('#skin_color').attr("href", base_url + "assets/css/themes/" + appSetting.theme + ".css");
        ...
        $('input[name="setting-theme"]').change(function () {
            ...
            $('#skin_color').attr("href", base_url + "assets/css/themes/" + selectedTheme + ".css");
        ...
        function switchLogo(theme) {
            switch (theme) {
                ...
                case "theme-5":
                case "theme-6":
                    $(".navbar-brand img").attr("src", base_url + "assets/images/logo.png");
                    break;
